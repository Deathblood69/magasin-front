<script lang="ts" setup>
  ...
  interface Props {
    modelValue: Produit | Omit<Produit, 'id'>
  }
  ...
  /** === EMITS === */
  type Emits = {
    'update:modelValue': [value: Produit | Omit<Produit, 'id'>]
  }
  ...
  const user = computed({
    get: () => props.modelValue as Produit | Omit<Produit, 'id'>,
    set: (value: Produit | Omit<Produit, 'id'>) =>

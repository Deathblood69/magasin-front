<script lang="ts" setup>
  ...
  interface Props {
    modelValue: Client | Omit<Client, 'id'>
  }
  ...
  /** === EMITS === */
  type Emits = {
    'update:modelValue': [value: Client | Omit<Client, 'id'>]
  }
  ...
  const user = computed({
    get: () => props.modelValue as Client | Omit<Client, 'id'>,
    set: (value: Client | Omit<Client, 'id'>) =>
